...
public class floatc extends ImageButton
{
	Paint buttonPaint;

	public floatc(Context context, AttributeSet set, int der){
		super(context,set,der);
		init();
	}
	public floatc(Context context){
		super(context);
		init();
	}
	public floatc(Context context, AttributeSet set){
		super(context,set);
		init();
	}
	private void init(){
		...
		buttonPaint.setColor(Color.argb(250,229,40,10));
